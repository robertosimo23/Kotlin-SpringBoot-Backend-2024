...
private fun buildCredit(
    ...
    dayFirstInstallment: LocalDate = LocalDate.of(2024,Month.OCTOBER,23),
...
private fun buildCustomer(
    firstName: String = "Roberto ",
    lastName: String = "Simões",
    cpf: String = "0285950225",
    email: String = "simoes9523@outlook.com",
    password: String = "v64qTLoa@23",
    zipCode: String = "69025060",
    street: String = "Rua barcelos",
