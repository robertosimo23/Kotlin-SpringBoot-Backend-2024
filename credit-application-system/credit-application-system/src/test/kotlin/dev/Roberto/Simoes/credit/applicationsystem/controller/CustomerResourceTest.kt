...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("Cavalcante"))
    ...
    fun`should not save a customer with same CPF and return 409 status `(){
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URL)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.timestamp").doesNotHaveJsonPath())
    ...
    @Test
    fun ` should fin customer by id and return 200 status`(){
        //given
    ...
    @Test
    fun ` should fin customer with invalid id and return 400 status`(){
      //given
      ...
      //when
        mockMvc.perform(MockMvcRequestBuilders.get("$URL/$invalidId").accept(MediaType.APPLICATION_JSON))
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.exception")
                    .value("class dev.Roberto.Simoes.credit.applicationsystem.excepitons.BusinessException")
            )
            .andExpect(MockMvcResultMatchers.jsonPath("$.details[*]").isNotEmpty)
            .andDo(MockMvcResultHandlers.print())
